...
/// Initialization Key for enabling skin whitening feature. Associated value must be a NSNumber (BOOL)
DTF_EXPORT DTFCameraInitKey DTFCameraInitKeyBeautyEnabled;
