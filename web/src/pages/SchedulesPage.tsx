...
export default function SchedulesPage() {
  ...
  const load = useCallback(async (p = 1) => {
    setLoading(true);
    try {
      const res = await api.get('/admin/schedules', { params: { page: p, size: 20, keyword: keyword || undefined } });
  ...
  return (
    <div>
      ...
      <input placeholder="搜索标题/描述..." value={keyword} onChange={e => setKeyword(e.target.value)}
